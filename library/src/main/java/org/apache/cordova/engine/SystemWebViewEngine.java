...
public class SystemWebViewEngine implements CordovaWebViewEngine {
    ...
    public void init(CordovaWebView parentWebView, CordovaInterface cordova, Client client,
        ...
        if (mHttpResourceLoader != null) {
            this.resourceApi.setExternalHttpResourceLoader(mHttpResourceLoader);
        }
    ...
    HttpResourceLoader mHttpResourceLoader;

    public void  setExternalHttpResourceLoader(HttpResourceLoader loader){
        mHttpResourceLoader = loader;
      //resourceApi.setExternalHttpResourceLoader(loader);
    }
